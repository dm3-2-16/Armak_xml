...
public class MainWindow extends Application {
    ...
    public void start(Stage stage) throws ParserConfigurationException, SAXException, IOException {
        ObservableList<Armak> obListDatuak;
        ...
        obListDatuak = GestionListaEnMemoria.cargaArmas(file);
        table.setItems(obListDatuak);
        ...
        addButton.setOnAction((ActionEvent e) -> {
            ...
            GestionListaEnMemoria.lista_gordexml(obListDatuak, file);
